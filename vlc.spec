%global vlc_rc			-20160926-0221-git
...
# patches to allow vlc to be built with gcc 4.8.5
Patch1:		vlc_fixups.h.patch
...
%{?_with_fluidsynth:BuildRequires: lash-devel}
...
%changelog
* Sun Oct 2 2016 Fredrik Fornstad <fredrik.fornstad@gmail.com> - 3.0.0-0.9
- Update to 20160926 snapshot
- Updated build deps and removed Wayland related items
- Added patch to allow successful build using GCC 4.8.5
- Removed skins2 and svlc file references
